/**
 * @file example.cpp - demonstrate use of ThreadGroup class for hw0
 * @author Kevin Lundeen
 * @see "Seattle University, CPSC5600, Winter 2026"
 */
#include <iostream>
#include <string>
...
public:
	void operator()(int id, void *sharedData) {
		...
		auto *ourData = (std::string*)sharedData;
...
int main() {
	...
	// Create a thread group using our hw0-provided ThreadGroup class.
	//
